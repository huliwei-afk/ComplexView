    ...
    private static HashMap<String, List<String>> hashMap = new HashMap<String, List<String>>() {
        {
            put("Xiaomi", Arrays.asList(
                    ...
                    "com.miui.securitycenter/com.miui.networkassistant.ui.base.UniversalFragmentActivity",
...
//                    "com.vivo.permissionmanager"
            ...
            put("OPPO", Arrays.asList(
                    "com.android.settings/com.coloros.settings.ColorSubSettings"
                ...
                for (String act : actCompatList) {
                    try {
                        ...
                        if (act.contains("/")) {
                            ...
                            intent = context.getPackageManager().getLeanbackLaunchIntentForPackage(act);
                        }
